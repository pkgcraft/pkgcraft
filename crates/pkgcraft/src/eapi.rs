...
pub static EAPI5: LazyLock<Eapi> = LazyLock::new(|| {
    ...
    Eapi::new("5", None)
        ...
        .update_commands([
            ...
            best_version.allowed_in([Phases]),
            ...
            eend.allowed_in([Phases]),
            eerror.allowed_in([Phases]),
            ...
            nonfatal.allowed_in([All]),
            unpack.allowed_in([Phases]),
            use_.allowed_in([Phases]),
            use_enable.allowed_in([Phases]),
            use_with.allowed_in([Phases]),
            useq.allowed_in([Phases]),
            usev.allowed_in([Phases]),
            usex.allowed_in([Phases]),
            // phase stubs that force direct calls to error out
            pkg_config.allowed_in([All]),
            pkg_info.allowed_in([All]),
            pkg_nofetch.allowed_in([All]),
            pkg_postinst.allowed_in([All]),
            pkg_postrm.allowed_in([All]),
            pkg_preinst.allowed_in([All]),
            pkg_prerm.allowed_in([All]),
            pkg_pretend.allowed_in([All]),
            pkg_setup.allowed_in([All]),
            src_compile.allowed_in([All]),
            src_configure.allowed_in([All]),
            src_install.allowed_in([All]),
            src_prepare.allowed_in([All]),
            src_test.allowed_in([All]),
            src_unpack.allowed_in([All]),
        ])
        .update_phases([
            PkgConfig.into(),
            PkgInfo.into(),
...
pub static EAPI7: LazyLock<Eapi> = LazyLock::new(|| {
    ...
    Eapi::new("7", Some(&EAPI6))
        ...
        .update_commands([
            ...
            eqawarn.allowed_in([Phases]),
            ver_cut.allowed_in([All]),
            ver_rs.allowed_in([All]),
            ver_test.allowed_in([All]),
        ])
        ...
        .update_env([
            BROOT.allowed_in([Src]).allowed_in([
                PkgSetup,
                PkgPreinst,
                PkgPostinst,
                PkgPrerm,
