...
pub static EAPI5: Lazy<Eapi> = Lazy::new(|| {
    ...
    Eapi::new("5", None)
        ...
        .update_commands([
            ...
            Command::new(assert, [Phases]),
            Command::new(best_version, [Phases]),
            Command::new(command_not_found_handle, [All]),
            Command::new(debug_print, [Eclass, Phases]),
            Command::new(debug_print_function, [Eclass, Phases]),
            Command::new(debug_print_section, [Eclass, Phases]),
